  ...
  <div class="widget w-6" id="widget-challenge">
    <div
      ...
      style="
        width: 250px;
        height: 250px;
        background: radial-gradient(circle, rgba(255, 180, 50, 0.1), transparent);
        top: -60px;
        right: -60px;
      "
    ></div>
    ...
    <div class="challenge-problem">
      <div class="challenge-problem-title">Longest Substring Without Repeating Characters</div>
      <div class="challenge-problem-desc">
        Given a string <span class="code-inline">s</span>, find the length of the longest substring
        without repeating characters.<br /><br />
        <strong>Examples:</strong><br />
        <span class="code-inline">"abcabcbb"</span> →
        <span class="code-inline">3</span> &nbsp;(substring "abc")<br />
        <span class="code-inline">"bbbbb"</span> →
        <span class="code-inline">1</span> &nbsp;(substring "b")<br />
        <span class="code-inline">"pwwkew"</span> →
        <span class="code-inline">3</span> &nbsp;(substring "wke")
        <div class="challenge-code">
          def lengthOfLongestSubstring(s: str) -> int: # Your solution here pass
        </div>
      </div>
    </div>
    ...
    <div class="challenge-solvers">
      <div v-for="(s, i) in solvers" :key="i" class="challenge-solver" :class="{ me: s.me }">
...
const SEED_SOLVERS = props.config
  ? props.config.seedSolvers
  : [
