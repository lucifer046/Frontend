...
const regionMeta = {
  bangalore: {
    ...
    heroTitle: 'Bangalore',
    heroDesc:
      "India's Silicon Valley meets IITM BS. Where techies, builders, and curious minds come together to grow beyond the screen.",
  },
  chandigarh: {
    chapterLabel: 'Chandigarh Chapter',
    heroTitle: 'Chandigarh',
    heroDesc:
      "India's most planned city hosts one of IITM BS's most organised student chapters. Clean, purposeful, and growing fast.",
  },
  chennai: {
    chapterLabel: 'Chennai Chapter',
    heroTitle: 'Chennai',
    heroDesc:
      "The city closest to IIT Madras. Chennai's chapter carries a special pride, linking students, alumni, and aspirants close to the programme's home base.",
  },
  delhi: {
    chapterLabel: 'Delhi NCR Chapter',
    heroTitle: 'Delhi',
    heroDesc:
      'Connecting students across Delhi, Noida, and Gurgaon through real meetups, student collaboration, and a strong IITM BS community.',
  },
  hyderabad: {
    chapterLabel: 'Hyderabad Chapter',
    heroTitle: 'Hyderabad',
    heroDesc:
      "Cyberabad to Charminar. Hyderabad's chapter blends city energy, student initiative, and a growing offline community.",
  },
  kolkata: {
    chapterLabel: 'Kolkata Chapter',
    heroTitle: 'Kolkata',
    heroDesc:
      "The city of joy, culture, and intellectual tradition. Kolkata's Sundarbans chapter brings warmth and academic rigour together.",
  },
  mumbai: {
    chapterLabel: 'Mumbai Chapter',
    heroTitle: 'Mumbai',
    heroDesc:
      'A wide regional chapter spanning Mumbai, Pune, Nagpur, Ahmedabad, and beyond. High energy, large turnouts, and steady community momentum.',
  },
  patna: {
    chapterLabel: 'Patna Chapter',
    heroTitle: 'Patna',
    heroDesc:
      'One of the fastest-growing Sundarbans chapters, with meetups across Bihar and neighbouring cities built around strong student participation.',
  },
  lucknow: {
    chapterLabel: 'Lucknow Chapter',
    heroTitle: 'Lucknow',
    heroDesc:
      'Connecting students across Uttar Pradesh. Bringing together academic excellence, shared learning, and offline community momentum.',
  },
};
...
function mapChandigarh(record, index) {
  ...
  const title =
    posterName && posterName.toLowerCase() !== 'meetup'
      ? `${location} – ${posterName}`
      : location
        ? `${location} Meetup`
        : 'Chandigarh Region Meetup';
  return {
    id: index + 1,
...
function mapBangalore(record, index) {
  ...
  return {
    ...
    about:
      ...
      'Meetup details have not been added yet, but the chapter turnout is recorded in the export.',
    attended,
    photos,
    tags: buildTags([location, ...splitCollaboration(record.Collaboration)]),
...
export const regionConfigs = {
  bangalore: buildConfig(
    regionMeta.bangalore,
    normalizeRecords(bengaluruRegion.records || [], mapBangalore)
  ),
  chandigarh: buildConfig(
    regionMeta.chandigarh,
    normalizeRecords(chandigarhRegion.records || [], mapChandigarh)
  ),
  chennai: buildConfig(
    regionMeta.chennai,
    normalizeRecords(chennaiRegion.records || [], mapChennai)
  ),
  delhi: buildConfig(regionMeta.delhi, normalizeRecords(delhiRegion.records || [], mapDelhi)),
  hyderabad: buildConfig(
    regionMeta.hyderabad,
    normalizeRecords(hyderabadRegion.records || [], mapHyderabad)
  ),
  kolkata: buildConfig(
    regionMeta.kolkata,
    normalizeRecords(kolkataRegion.records || [], mapKolkata)
  ),
  lucknow: buildConfig(
    regionMeta.lucknow,
    normalizeRecords(lucknowRegion.records || [], mapLucknow)
  ),
