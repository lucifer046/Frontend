  ...
  <div>
    ...
    <section class="magazine-entry rs">
      ...
      <button
        ...
        @click="openMagazine"
      >
        <img :src="magazinePreview" alt="The Delta Diaries, Sundarbans House annual magazine" />
      </button>
    </section>
        ...
        <div class="about-grid">
          <div class="about-text-col">
            ...
            <h2 class="section-title-xl">
              Named after the
              <span class="tg">world's largest mangrove forest</span>
            </h2>
            <p class="desc">
              Sundarbans House is one of the vibrant student houses under the IIT Madras BS Online
              Degree Programme. We are a diverse community of learners, innovators, and leaders
              spread across India and beyond, united by our passion for knowledge and excellence.
            </p>
            <p class="desc">
              Just as the Sundarbans ecosystem thrives through collaboration of diverse species, our
              house flourishes through the collective efforts of our members from all walks of life.
            </p>
            <p class="desc">
              From Foundation level students to advanced BS degree scholars — we grow together,
              learn together, and celebrate together.
            </p>
            <h3
              style="
            ...
            <p class="desc">
              Sundarbans House is one of the most active and dynamic student communities within the
              IIT Madras BS Degree Programme. It represents a network of passionate individuals who
              come together to connect, collaborate, and grow beyond academics.
            </p>
            <p class="desc">
              Inspired by unity and collaboration, the house creates a platform where students
              support each other and experience a meaningful college life, even in an online
              environment.
            </p>
          </div>
          <div class="about-img-col">
            <div class="about-img-stack">
              ...
              <div class="about-img-badge">
                <div class="ib-num">Since 2021</div>
                <div class="ib-label">Founded</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="grid-2" style="gap: 3rem; align-items: center">
          <div>
            ...
            <h2 class="section-title-xl">Discover your <span class="tg">potential</span></h2>
            <p class="desc" style="font-size: 1.05rem">
              To build a strong, inclusive, and growth-driven community where every student can
              discover their potential, develop skills, and emerge as a future leader.
            </p>
          </div>
          <div class="card-base" style="padding: 2.5rem">
            ...
            <ul
              class="mission-list"
              style="line-height: 1.9; color: var(--text2); padding-left: 1.2rem"
            >
              <li>Promote collaboration and teamwork</li>
              <li>Encourage learning beyond academics</li>
              <li>Provide opportunities for leadership and innovation</li>
              <li>Build a supportive and inclusive environment</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <section class="section rs" style="background: var(--bg2)">
      <div class="container">
        <div class="sec-hdr">
          ...
          <h2 class="section-title-xl">What <span class="tg">drives us</span></h2>
        </div>
        <div class="grid-3">
          <div
            class="card-base rc"
            style="--card-delay: 0.1s; text-align: center"
            v-for="v in values"
            :key="v.title"
          >
            ...
            <p class="desc" style="margin: 0">{{ v.desc }}</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section rs">
      <div class="container">
        ...
        <div class="stats-band grid-4" style="gap: 1.5rem">
          <div class="card-base" style="text-align: center" v-for="s in stats" :key="s.label">
            <div
              class="stat-number"
              :data-count="s.count"
            ...
            <div style="color: var(--text2); font-size: 0.85rem; margin-top: 0.3rem">
              {{ s.label }}
            </div>
          </div>
        </div>
    ...
    <section class="section rs" style="background: var(--bg2)">
      <div class="container">
        <div class="sec-hdr">
          ...
          <h2 class="section-title-xl">Built for <span class="tg">students, by students</span></h2>
        </div>
        <div class="grid-2">
          <div class="card-base rs">
            ...
            <p class="desc" style="margin: 0">
              Providing curated study materials, doubt sessions, and peer tutoring to help every
              member excel in their academics — from Foundation to advanced BS levels.
            </p>
          </div>
          <div class="card-base rs">
            <div style="font-size: 2rem; margin-bottom: 1rem">🌐</div>
            ...
            <p class="desc" style="margin: 0">
              Connecting students through interactions, meetups, and collaborative initiatives,
              ensuring no one feels disconnected in an online program.
            </p>
          </div>
          <div class="card-base rs">
            <div style="font-size: 2rem; margin-bottom: 1rem">🚀</div>
            ...
            <p class="desc" style="margin: 0">
              Focusing on holistic growth — from coding and design to communication and management —
          ...
          <div class="card-base rs">
            ...
            <p class="desc" style="margin: 0">
              Organizing workshops, webinars, hackathons, competitions, meetups, networking
              sessions, and cultural events that build confidence and practical exposure.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="section rs">
      <div class="container">
        <div class="sec-hdr">
          ...
          <h2 class="section-title-xl">Find your <span class="tg">space to grow</span></h2>
        </div>
        <div class="grid-2">
    ...
    <section class="section rs" style="background: var(--bg2)">
      <div class="container">
        <div class="sec-hdr">
          <h2 class="section-title-xl">What Makes Us <span class="tg">Different</span></h2>
        </div>
        <div class="grid-3">
          <div
            class="card-base rc"
      ...
      <div class="container">
        ...
        >
          ...
          <p
            ...
            "
          >
            Sundarbans House is not just a community — it's a family where learning meets belonging.
          </p>
    ...
    <section class="section rs" style="background: var(--bg2)">
      <div class="container">
        <div class="sec-hdr">
          ...
          <h2 class="section-title-xl">The people who <span class="tg">built this</span></h2>
          <p class="desc" style="max-width: 600px; margin: 0 auto 2rem">
            Over the years, Sundarbans House has been shaped by dedicated leaders whose vision and
            efforts have built a strong and inspiring community.
          </p>
        </div>

        <div style="display: flex; flex-direction: column; gap: 2rem">
          <div class="card-base" v-for="year in leadership" :key="year.period">
            <div
              style="
                display: flex;
                align-items: center;
              ...
              >
                ...
                <div style="display: flex; gap: 0.5rem; flex-wrap: wrap">
                  ...
                  <a
                    ...
                    onmouseout="this.style.background = 'rgba(212,160,23,0.08)'"
                  >
                    <svg
    ...
    >
      <div class="container">
        <div class="cta-wrap">
          <div class="section-tag light">Be Part of Us</div>
          <h2 class="cta-heading">Join <span class="cta-acc">Sundarbans</span></h2>
          <p class="cta-sub">
            Become part of one of IIT Madras BS's most vibrant student communities. Connect, learn,
            and grow with thousands of motivated students.
          </p>
          <div class="cta-acts">
            <router-link to="/community" class="cta-btn-p">Join Community →</router-link>
...
const magazineEmbedUrl = 'https://player.flipsnack.com?hash=N0U3Nzg2RUQ3NUUrdTVzNGt1ZDJneA==';
